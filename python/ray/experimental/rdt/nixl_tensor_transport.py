        ...
        try:
            ...
            if NIXL_REMOTE_AGENT_CACHE_MAXSIZE > 0 and remote_name:
                with self._inflight_cond:
                    # If previously marked for pending removal, clear it since we are active again
                    self._pending_removal_agents.discard(remote_name)
            ...
            self._cleanup_transfer(
                obj_id, tensors, xfer_handle, remote_name, added_tensor_descs, inflight_incremented
            )
